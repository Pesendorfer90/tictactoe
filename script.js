...
function restart() {
    ...
    document.getElementById('game-over').classList.remove('game-over-out');
...
function checkForWin() {
    ...
    if (winner) {
        console.log('GEWONEN:', winner);
        gameOver = true;
        setTimeout(function () {
            document.getElementById('game-over').classList.remove('d-none');
        }, 1000);
        setTimeout(function() {
            document.getElementById('game-over').classList.add('game-over-out');
        }, 2000);
        setTimeout(function () {
            document.getElementById('game-over').classList.add('d-none');
        }, 2500);
